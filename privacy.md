...
### 7.3 Google LLC (Firebase Analytics)

We use Firebase Analytics, a product of Google LLC, to collect the pseudonymous usage statistics described in Section 3.2. Firebase Analytics is operated by Google in its capacity as the developer of the Firebase platform. We act as the controller of the data we configure Firebase Analytics to collect; Google acts as a processor with respect to the parts of that data that are personal data, and as an independent controller for the parts that it uses for its own purposes as described in the Google Measurement Controller-Controller Data Protection Terms.
...
Google's handling of personal data is governed by the [Google Privacy Policy](https://policies.google.com/privacy), the [Firebase Privacy and Security Information](https://firebase.google.com/support/privacy), and the data processing terms applicable to Firebase customers.

We do not transmit your photos, your photo metadata, your cleanup decisions, or your cleanup history to Firebase Analytics.
...
- For transfers to Google in connection with Firebase Analytics: the **Standard Contractual Clauses** included in the Google Ads Data Processing Terms and the Firebase Data Processing and Security Terms, and, for transfers to the United States, the **EU–U.S. Data Privacy Framework** to which Google LLC has certified.
